...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      var map = _this.$parent.$parent.$parent.$parent.$parent.$refs.map.mapObject;
